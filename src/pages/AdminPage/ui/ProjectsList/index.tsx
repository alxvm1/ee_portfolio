import { projectModel, type TAnyProject, type TProjectCategory } from "@entities/Project";
...
export const ProjectsList: FC<TProjectsListProps> = ({ category }) => {
  ...
  const [projectDeleteClicked, projectPublishToggled, projectMoveClicked] = useUnit([
            ...
            <CardContent className="projects-list__item">
              ...
              <div className="projects-list__controls">
                <Button
                  ...
                  aria-label={project.is_published ? "Скрыть проект" : "Показать проект"}
                >
                  {project.is_published ? (
                ...
                <Button
                  ...
                  variant="outline"
                  disabled={index === 0}
                  onClick={() => projectMoveClicked({ category, index, direction: "up" })}
                >
                  ↑
                </Button>
                <Button
                  ...
                  onClick={() => projectMoveClicked({ category, index, direction: "down" })}
                >
                  ↓
                </Button>
                <Button
